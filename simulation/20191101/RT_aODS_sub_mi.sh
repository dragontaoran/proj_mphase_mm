...
echo "#SBATCH --time=06-00:00:00  # Wall Clock time (dd-hh:mm:ss) [max of 14 days]" >> tmp.slurm
echo "#SBATCH --array=1-1000" >> tmp.slurm
...
echo "" >> tmp.slurm
echo "Rscript RT_aODS_sim.R \$SLURM_ARRAY_TASK_ID ${dir} MI" >> tmp.slurm
